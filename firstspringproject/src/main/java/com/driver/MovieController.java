...
public class MovieController {
    ...
    public ResponseEntity<List<Movie>> getMoviesByDirectorName(@PathVariable String name){
        List<com.driver.Movie> list=movieService.getMoviesByDirectorName(name);
